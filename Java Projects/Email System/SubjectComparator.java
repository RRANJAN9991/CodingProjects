...
* two Email objects to determine which has a subject that has its letters come later in the alphabet.
*/
...
public class SubjectComparator implements Comparator, Serializable {
    ...
    * which has a subject that has its letters come later in the alphabet.
    * @param a
