...
* two Email objects to determine which came after the other.
*/

public class DateComparator2 implements Comparator, Serializable{
    
    /**
    * compare(Object o1, Object o2) is a method that compares two Email objects to determine which came after the other.
    * @param o1
